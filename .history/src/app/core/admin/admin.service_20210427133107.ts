...
export class AdminService {
    ...
    manualDeposit = (payload: IManualDeposit): Observable<IManualDepositResponse> => {
        return this.httpClient.post<IManualDepositResponse>('endpoint', payload);
    }
}
