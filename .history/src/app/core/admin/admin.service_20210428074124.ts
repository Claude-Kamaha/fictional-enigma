...
export class AdminService {
    ...
    const apiHost = `https://sandbox.nellys-coin.ejaraapis.xyz/`;

    // ** crypto related methods
    saveCryptoSellingPrice = (payload: ISaveCryptoSellingPrice): Observable<IGenericReponse> => {
        return this.httpClient.post<IGenericReponse>(`${apiHost}/admin/save-crypto-selling-price`, payload);
    }

    changeCryptoSettings = (payload: IChangeCryptoSettings): Observable<IGenericReponse> => {
        return this.httpClient.put<IGenericReponse>(`${apiHost}/admin/change-crypto-settings`, payload);
    }

    updateCryptoBalance = (payload: IUpdateCryptoBalance): Observable<IGenericReponse> => {
        return this.httpClient.put<IGenericReponse>(`${apiHost}/admin/update-crypto-balance`, payload);
    }

    updateCryptoUsdPrice = (payload: IUpdateCryptoUsdSellingPrice): Observable<IGenericReponse> => {
        return this.httpClient.put<IGenericReponse>(`${apiHost}/admin/update-crypto-usd-price`, payload);
    }
    ...
    createCustomerFiatWallet = (payload: ICreateCustomerFiatWallet): Observable<ICreateCustomerFiatWalletResponse> => {
        return this.httpClient.post<ICreateCustomerFiatWalletResponse>(`${apiHost}/admin/create-fiat-wallet-for-customer`, payload);
    }

    getCustomerListPerStatus = (params: HttpParams): Observable<IGetCustomerListPerStatusResponse> => {
        return this.httpClient.get<IGetCustomerListPerStatusResponse>(`${apiHost}/admin/get-customer-list-per-status`, { params });
    }

    getCustomerDetails = (params: HttpParams): Observable<IGetCustomerDetailsResponse> => {
        return this.httpClient.get<IGetCustomerDetailsResponse>(`${apiHost}/admin/get-customer-details`, { params });
    }

    getCustomerWallets = (params: HttpParams): Observable<IGetCustomerWalletsResponse> => {
        return this.httpClient.get<IGetCustomerWalletsResponse>(`${apiHost}/admin/get-customer-wallets`, { params });
    }

    updateCustomerLoyaltyLevel = (payload: IUpdateCustomerLoyaltyLevel): Observable<IGenericReponse> => {
        return this.httpClient.put<IGenericReponse>(`${apiHost}/admin/update-customer-loyalty-level`, payload);
    }

    changeCustomerType = (payload: IChangeCustomerType): Observable<IGenericReponse> => {
        return this.httpClient.put<IGenericReponse>(`${apiHost}/admin/change-customer-type`, payload);
    }

    changeUserStatus = (payload: IChangeUserStatus): Observable<IGenericReponse> => {
        return this.httpClient.put<IGenericReponse>(`${apiHost}/admin/change-user-status`, payload);
    }

    updateCountryFeatureStatus = (payload: IUpdateCountryFeatureStatus): Observable<IGenericReponse> => {
        return this.httpClient.put<IGenericReponse>(`${apiHost}/admin/update-country-feature-status`, payload);
    }

    updateCountryStatus = (payload: IUpdateCountryStatus): Observable<IGenericReponse> => {
        return this.httpClient.put<IGenericReponse>(`${apiHost}/admin/update-country-status`, payload);
    }

    migrateFiatWallet = (payload: IMigrateFiatWallet): Observable<IGenericReponse> => {
        return this.httpClient.post<IGenericReponse>(`${apiHost}/admin/migrate-fiat-wallet`, payload);
    }

    // ** transactions related methods
    saveMigrationData = (payload: ISaveMigrationData): Observable<IGenericReponse> => {
        return this.httpClient.post<IGenericReponse>(`${apiHost}/admin/save-migration-data`, payload);
    }

    manualDeposit = (payload: IManualDeposit): Observable<IManualTransactionResponse> => {
        return this.httpClient.post<IManualTransactionResponse>(`${apiHost}/admin/manual-deposit`, payload);
    }

    manualBuy = (payload: IManualBuy): Observable<IManualTransactionResponse> => {
        return this.httpClient.post<IManualTransactionResponse>(`${apiHost}/admin/manual-buy`, payload);
    }

    manualBuyPaymentUpdate = (payload: IManualBuyPaymentUpdate): Observable<IGenericReponse> => {
        return this.httpClient.post<IGenericReponse>(`${apiHost}/admin/manual-buy-payment-update`, payload);
    }

    revertManualTransaction = (payload: IRevertManualTransaction): Observable<IGenericReponse> => {
        return this.httpClient.post<IGenericReponse>(`${apiHost}/admin/revert-manual-transaction`, payload);
    }

    changeMoonpaySettings = (payload: IChangeMoonpaySettings): Observable<IGenericReponse> => {
        return this.httpClient.put<IGenericReponse>(`${apiHost}/admin/change-moonpay-settings`, payload);
    }

    deleteTransaction = (params: HttpParams): Observable<IGenericReponse> => {
        return this.httpClient.delete<IGenericReponse>(`${apiHost}/admin/delete-transaction`, { params });
    }
}
