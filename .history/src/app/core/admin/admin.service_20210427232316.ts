...
export class AdminService {
    ...
    changeCustomerType = (payload: IChangeCustomerType): Observable<IGenericHttpReponse> => {
        return this.httpClient.put<IGenericHttpReponse>('endpoint', payload);
    }
    ...
    manualBuyPaymentUpdate = (payload: IManualBuyPaymentUpdate): Observable<IManualTransactionResponse> => {
        return this.httpClient.post<IManualTransactionResponse>('endpoint', payload);
    }
    ...
    changeMoonpaySettings = (payload: IChangeMoonpaySettings): Observable<IGenericHttpReponse> => {
        return this.httpClient.put<IGenericHttpReponse>('endpoint', payload);
    }
